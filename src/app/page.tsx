...
export default function Home() {
  return (
    <main className="relative flex min-h-screen w-full flex-col items-center overflow-x-hidden bg-[#2a3b2d] bg-[url('/new-background.webp')] bg-cover bg-center bg-no-repeat">
      <SnowFall />
      <div className="z-[2] flex h-[60vh] min-h-[300px] w-full items-center justify-center bg-[url('/hero-image.jpg')] bg-cover bg-center">
        <Card className="z-10 border-0 bg-transparent text-center shadow-none">
          <CardContent className="p-4 md:p-16">
            <p className="mb-2 text-2xl font-normal text-[#8b1a1a] md:text-4xl">
              &apos;Tis the season to get married
            </p>
            <h1 className="mb-4 text-5xl font-semibold text-[#8b1a1a] md:text-8xl">
              Andrew & Jade
            </h1>
            <p className="text-xl font-normal text-[#2a3b2d] md:text-3xl">
              invite you to their wedding
            </p>
            <p className="mt-2 text-xl font-normal text-[#2a3b2d] md:text-3xl">
              December 13, 2025
            </p>
          </CardContent>
        </Card>
          ...
          <Card className="border-2 border-[#8b1a1a]/20 bg-white/85">
            ...
            <CardContent className="text-center text-gray-600">
              <p className="leading-relaxed">
                Well, Jade and I met when she got banned off Tinder. We then met
                on Bumble after I told her a solid dad joke. (It was a fight to
                the death between me and a guy who really REALLY liked cats...).
                I mustered up the courage to ask her out on a date, and we met
                here at the Koffee Hause. We really hit it off. It felt like we
                knew each other for years. Then she had to work. I wanted to
                walk her to her car, but then I realized why she didn&apos;t
                want that: her cow covered car named &quot;Peggy Sue&quot;. That
                should have scared me off, but I asked her on an improntu date
                ...
                she finished hatching her eggs in Pokemon Go. That solidified my
                belief that she was the one for me and I want to spend the rest
                of my life with her and her dorky self.
              </p>
            </CardContent>
          </Card>
        </section>
